...
// #define LF_EM_ON HAL_GPIO_WritePin(LF_EMITTER_GPIO_Port, LF_EMITTER_Pin,
// GPIO_PIN_SET) #define LF_EM_OFF HAL_GPIO_WritePin(LF_EMITTER_GPIO_Port,
// LF_EMITTER_Pin, GPIO_PIN_RESET) #define RF_EM_ON
// HAL_GPIO_WritePin(RF_EMITTER_GPIO_Port, RF_EMITTER_Pin, GPIO_PIN_SET) #define
// RF_EM_OFF HAL_GPIO_WritePin(RF_EMITTER_GPIO_Port, RF_EMITTER_Pin,
// GPIO_PIN_RESET) #define SIDE_EM_ON
// HAL_GPIO_WritePin(DIAGONAL_EMITTER_GPIO_Port, DIAGONAL_EMITTER_Pin,
// GPIO_PIN_SET) #define SIDE_EM_OFF
// HAL_GPIO_WritePin(DIAGONAL_EMITTER_GPIO_Port, DIAGONAL_EMITTER_Pin,
// GPIO_PIN_RESET)
//
...
// #define LED10_OFF HAL_GPIO_WritePin(LED10_GPIO_Port, LED10_Pin,
// GPIO_PIN_RESET) #define LED11_ON HAL_GPIO_WritePin(LED11_GPIO_Port,
// LED11_Pin, GPIO_PIN_SET) #define LED11_OFF HAL_GPIO_WritePin(LED11_GPIO_Port,
