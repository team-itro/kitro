...
void doPID1(long encoder_count, int target_ticks_per_frame, float Kp, float Kd,
            float Ki)
{
  long Perror;
  float output;
...
void doPID2(long encoder_count, int target_ticks_per_frame, float Kp, float Kd,
            float Ki)
{
  long Perror;
  float output;
...
void updatePID(void)
{
  ...
  //    doPID(&leftPID_Output, encoder1, targetTicksPerFrame1,
  //    &left_prev_encoder, &left_prev_input, &left_ITerm, Kp1, Kd1, Ki1);
  //    doPID(&rightPID_Output, encoder2, targetTicksPerFrame2,
  //    &right_prev_encoder, &right_prev_input, &right_ITerm, Kp2, Kd2, Ki2);
