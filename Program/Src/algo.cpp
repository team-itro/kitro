...
int flood[ROWS][COLUMNS] = {{12, 11, 10, 9, 8, 7, 6, 6, 7, 8, 9, 10, 11, 12},
...
// void forwardtrack(struct coordinate dumXY,struct coordinate dumXY_prev, int
// dumOrient){ 	while(1){ 		if (backFlood[dumXY.y][dumXY.x]==0){ 			ptr -= 1; 			fwdPtr =
//ptr;
//			// log("breaking");
//			break;
//		}
